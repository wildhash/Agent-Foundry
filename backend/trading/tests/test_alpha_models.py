...
class TestMeanReversionModel:
    ...
    def test_zscore_extreme(self):
        ...
        prices = np.concatenate([np.full(100, 100), np.linspace(100, 120, 50)])  # Flat  # Big move up
...
class TestAlphaEnsemble:
    ...
    def test_init(self):
        ...
        models = {"momentum": MomentumAlphaModel(), "mean_reversion": MeanReversionAlphaModel()}
    ...
    def test_combined_signal(self):
        ...
        signal = ensemble.generate_combined_signal(ohlcv=ohlcv, regime=MarketRegime.NORMAL)
