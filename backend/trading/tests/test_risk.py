...
class TestVolatilityTargetedSizer:
    ...
    def test_size_position_high_vol(self):
        ...
        pos_normal = sizer.size_position(
            signal=signal,
            asset_vol=0.15,
            nav=100000,
            current_price=100
        ...
        pos_high = sizer.size_position(
            signal=signal,
            asset_vol=0.30,  # 2x normal
            nav=100000,
            current_price=100
        )
    ...
    def test_size_position_low_vol(self):
        ...
        pos = sizer.size_position(
            signal=signal,
            asset_vol=0.05,  # Very low vol
            nav=100000,
            current_price=100
        )
    ...
    def test_kelly_size(self):
        ...
        # No edge
        kelly_no_edge = sizer.kelly_size(
            win_rate=0.50,
            win_loss_ratio=1.0
        )
...
class TestRiskManager:
    ...
    def test_check_limits_approved(self):
        ...
        position = PositionSize(
            percent_of_nav=0.10,  # 10% position
            dollar_amount=10000,
            num_units=100
        )
    ...
    def test_check_limits_position_size_violated(self):
        ...
        position = PositionSize(
            percent_of_nav=0.30,  # 30% > 20% limit
            dollar_amount=30000,
            num_units=300
        )
