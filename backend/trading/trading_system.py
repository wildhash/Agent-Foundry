...
from .monitoring import (
    PerformanceTracker, DriftDetector, OnlineLearner, ModelSelector
)
...
class TradingSystem:
    ...
    def trading_iteration(
        ...
        if risk_check.approved and combined_signal.is_active:
            ...
            scaled_position = self.risk_manager.scale_for_risk(
                target_position,
