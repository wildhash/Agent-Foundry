...
class DriftDetector:
    ...
    def __init__(self, window_size: int = 1000, p_value_threshold: float = 0.05, psi_threshold: float = 0.25):
    ...
    def test_ks(self, feature_name: str, current_data: np.ndarray) -> DriftResult:
        """
    ...
    def test_psi(self, feature_name: str, current_data: np.ndarray, n_bins: int = 10) -> DriftResult:
        """
    ...
    def test_prediction_drift(
        self, predictions: np.ndarray, actuals: np.ndarray, reference_errors: Optional[np.ndarray] = None
    ) -> DriftResult:
        """
    ...
    def test_all_features(self, current_features: Dict[str, np.ndarray]) -> Dict[str, DriftResult]:
        """
