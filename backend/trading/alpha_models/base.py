...
class BaseAlphaModel(ABC):
    ...
    def __init__(self, name: str, lookback_periods: int = 100, min_data_points: int = 20):
        """
    ...
    def _store_signal(self, signal: AlphaSignal):
        ...
        self.signal_history.append({"timestamp": signal.timestamp, "value": signal.value, "confidence": signal.confidence})
